...
namespace StatisticsSystem.DAL
{
  ...
  public partial class JYXX_COL
  {
    ...
    public bool Exists(decimal JYXXID)
    {
      ...
      strSql.Append("select count(1) from JYXX_COL");
    ...
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("insert into JYXX_COL(");
      strSql.Append("JYXXID,BBBM,JYMC,JYMS,JYGX,JYSX,DWBM,NF,YF,ZBBM,ZD)");
      ...
      parameters[9].Value = model.ZBBM;
      parameters[10].Value = model.ZD;
    ...
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("update JYXX_COL set ");
      ...
      parameters[8].Value = model.ZBBM;
      parameters[9].Value = model.ZD;
      parameters[10].Value = model.JYXXID;
    ...
    public bool Delete(decimal JYXXID)
    {
      ...
      StringBuilder strSql = new StringBuilder();
      strSql.Append("delete from JYXX_COL ");
      strSql.Append(" where JYXXID=:JYXXID ");
      OracleParameter[] parameters = {
					new OracleParameter(":JYXXID", OracleDbType.Double,8)			};
      parameters[0].Value = JYXXID;
    ...
    public StatisticsSystem.Model.JYXX_COL GetModel(decimal JYXXID)
    {
      ...
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select JYXXID,BBBM,JYMC,JYMS,JYGX,JYSX,DWBM,NF,YF,ZBBM,ZD from JYXX_COL ");
      strSql.Append(" where JYXXID=:JYXXID ");
      OracleParameter[] parameters = {
					new OracleParameter(":JYXXID", OracleDbType.Double,8)			};
      parameters[0].Value = JYXXID;

      StatisticsSystem.Model.JYXX_COL model = new StatisticsSystem.Model.JYXX_COL();
    ...
    /// 得到一个对象实体
    /// </summary>
    public StatisticsSystem.Model.JYXX_COL DataRowToModel(DataRow row)
    {
      StatisticsSystem.Model.JYXX_COL model = new StatisticsSystem.Model.JYXX_COL();
      if (row != null)
      {
    ...
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select JYXXID,BBBM,JYMC,JYMS,JYGX,JYSX,DWBM,NF,YF,ZBBM,ZD ");
      strSql.Append(" FROM JYXX_COL ");
      if (strWhere.Trim() != "")
      {
    ...
    public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
    {
      ...
      strSql.Append(")AS Row, T.*  from JYXX_COL T ");
    ...
    public DataSet GetList_DW(string strWhere)
    {
      ...
      strSql.Append(" FROM JYXX_col a left join dwbmb b on a.dwbm=b.dwbm ");
      if (strWhere.Trim() != "")
      {
        strSql.Append(" where " + strWhere);
      }
    ...
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select decode(max(jyxxid),null,1,max(jyxxid)+1) FROM JYXX_col ");
      object obj = DbHelperOra.GetSingle(strSql.ToString());
      if (obj == null)
      {
        return 0;
