...
namespace StatisticsSystem.DAL
{
  ...
  public partial class ENCO_JSXXYSJ
  {
    ...
    public bool Exists(decimal JSXXID, string ONAME)
    {
      ...
      strSql.Append("select count(1) from ENCO_JSXXYSJ");
    ...
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("update ENCO_JSXXYSJ set ");
      ...
      parameters[6].Value = model.JSXXID;
    ...
    public bool Delete(decimal JSXXID, string ONAME)
    {
      ...
      StringBuilder strSql = new StringBuilder();
      strSql.Append("delete from ENCO_JSXXYSJ ");
      strSql.Append(" where JSXXID=:JSXXID and ONAME=:ONAME ");
      OracleParameter[] parameters = {
					new OracleParameter(":JSXXID", OracleDbType.Double,10),
					new OracleParameter(":ONAME", OracleDbType.Varchar2,10)			};
    ...
    public StatisticsSystem.Model.ENCO_JSXXYSJ GetModel(decimal JSXXID, string ONAME)
    {
      ...
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select JSXXID,ONAME,OBBBM,OZBBM,OZD,ODWBM,ONF,OYF from ENCO_JSXXYSJ ");
      strSql.Append(" where JSXXID=:JSXXID and ONAME=:ONAME ");
      OracleParameter[] parameters = {
					new OracleParameter(":JSXXID", OracleDbType.Double,10),
					new OracleParameter(":ONAME", OracleDbType.Varchar2,10)			};
      ...
      StatisticsSystem.Model.ENCO_JSXXYSJ model = new StatisticsSystem.Model.ENCO_JSXXYSJ();
    ...
    /// 得到一个对象实体
    /// </summary>
    public StatisticsSystem.Model.ENCO_JSXXYSJ DataRowToModel(DataRow row)
    {
      StatisticsSystem.Model.ENCO_JSXXYSJ model = new StatisticsSystem.Model.ENCO_JSXXYSJ();
      if (row != null)
      {
    ...
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select JSXXID,ONAME,OBBBM,OZBBM,OZD,ODWBM,ONF,OYF ");
      strSql.Append(" FROM ENCO_JSXXYSJ ");
      if (strWhere.Trim() != "")
      {
    ...
    public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
    {
      ...
      strSql.Append(")AS Row, T.*  from ENCO_JSXXYSJ T ");
    ...
    public DataSet GetList(int PageSize,int PageIndex,string strWhere)
    {
      ...
      parameters[0].Value = "ENCO_JSXXYSJ";
      parameters[1].Value = "ONAME";
    ...
    public DataSet GetList_jsxxysj(string jsxxid, string oname)
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select BBBM,ZD,ZDZS,SJLX,SJCD,SJJD,ZDSX,FLYC ");
      strSql.Append(" FROM ENCO_jsxxysj where jsxxid=:0 and oname=:1");
      OracleParameter[] parameters = {
					new OracleParameter(":0", OracleDbType.Int32),
    ...
    public DataSet GetList_jsxxid(int jsxxid)
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select BBBM,ZD,ZDZS,SJLX,SJCD,SJJD,ZDSX,FLYC ");
      strSql.Append(" FROM ENCO_jsxxysj where jsxxid=:0");
      OracleParameter[] parameters = {
					new OracleParameter(":0", OracleDbType.Int32)	};
      parameters[0].Value = jsxxid;
