...
namespace StatisticsSystem.DAL
{
  ...
  public partial class ZN_YYBB
  {
    ...
    public bool Exists(string BBBM, string YYBBBM)
    {
      ...
      strSql.Append("select count(1) from ZN_YYBB");
    ...
    {
      StringBuilder strSql = new StringBuilder();
      strSql.Append("update ZN_YYBB set ");
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！
    ...
    public bool Delete(string BBBM, string YYBBBM)
    {
      ...
      StringBuilder strSql = new StringBuilder();
      strSql.Append("delete from ZN_YYBB ");
      strSql.Append(" where BBBM=:BBBM and YYBBBM=:YYBBBM ");
      OracleParameter[] parameters = {
					new OracleParameter(":BBBM", OracleDbType.Varchar2,30),
					new OracleParameter(":YYBBBM", OracleDbType.Varchar2,30)			};
    ...
    public Maticsoft.Model.ZN_YYBB GetModel(string BBBM, string YYBBBM)
    {
      ...
      StringBuilder strSql = new StringBuilder();
      strSql.Append("select BBBM,YYBBBM from ZN_YYBB ");
      strSql.Append(" where BBBM=:BBBM and YYBBBM=:YYBBBM ");
      OracleParameter[] parameters = {
					new OracleParameter(":BBBM", OracleDbType.Varchar2,30),
					new OracleParameter(":YYBBBM", OracleDbType.Varchar2,30)			};
      ...
      Maticsoft.Model.ZN_YYBB model = new Maticsoft.Model.ZN_YYBB();
    ...
    /// 得到一个对象实体
    /// </summary>
    public Maticsoft.Model.ZN_YYBB DataRowToModel(DataRow row)
    {
      Maticsoft.Model.ZN_YYBB model = new Maticsoft.Model.ZN_YYBB();
      if (row != null)
      {
    ...
    public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
    {
      ...
      strSql.Append(")AS Row, T.*  from ZN_YYBB T ");
    ...
    public DataSet GetList_BBBM(string BBBM)
    {
      ...
      strSql.Append(" FROM ZN_YYBB a,code_bbbmb b,enco_bblx c where a.bbbm=:0 and a.YYBBBM=b.bbbm and b.bblx=c.id");
