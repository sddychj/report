...
{
  /// <summary>
  /// ENCO_JSXX:实体类(属性说明自动提取数据库字段的描述信息)
  /// </summary>
  [Serializable]
  public partial class ENCO_JSXX_List
  {
    public ENCO_JSXX_List()
    { }
    public ENCO_JSXX_List(int length)
    {
      _jsxxid = new decimal[length];
      _bbbm = new string[length];
      _zbbm = new string[length];
      _zd = new string[length];
      _jsms = new string[length];
      _dwbm = new string[length];
      _nf = new string[length];
      _yf = new string[length];
      _sfkdw = new string[length];
      _sfkb = new string[length];
      _sftz = new string[length];
    }
    #region Model
    ...
    private string[] _nf;
    private string[] _yf;
    private string[] _sfkdw;
    private string[] _sfkb;
