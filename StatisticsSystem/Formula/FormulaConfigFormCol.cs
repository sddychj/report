...
{
  public partial class FormulaConfigFormCol : Form, MainForm.ICipherInputForm
  {
    StatisticsSystem.BLL.ENCO_BBZD bll_zd = new BLL.ENCO_BBZD();
    StatisticsSystem.BLL.ENCO_JSXX_COL bll_jsxx = new BLL.ENCO_JSXX_COL();
    ...
    #region 初始化
    public FormulaConfigFormCol()
    {
      InitializeComponent();
    }

    public FormulaConfigFormCol(string _tableNum, string _dwbm, string _year, string _month)
    {
      InitializeComponent();
    ...
    private void InitCell()
    {
      ...
      jsxxidArray = new int[1, axCellFormulaConfig.GetCols(0) - 1];
      Classes.InitCell.InitCellFormulaCol(axCellFormulaConfig, tableNum, year, month, dwbm,
    ...
    private void axCellFormulaConfig_MenuCommand(object sender, AxCELL50Lib._DCell2000Events_MenuCommandEvent e)
    {
      ...
      switch (e.itemid)
      {
        ...
        case 1101://编辑公式
          ...
          int jsxxid = jsxxidArray[0, currentCol];
          if (jsxxid == 0)//为空则先保存
          {
            model_jsxx = new Model.ENCO_JSXX_COL();
            ...
            jsxxidArray[0, currentCol] = int.Parse(model_jsxx.JSXXID.ToString());
          }
          else
          {
            ...
            if (model_jsxx.JSMS != formula1101)
            {
              ...
              BLL.ENCO_JSXXYSJ_COL bll_ysj = new BLL.ENCO_JSXXYSJ_COL();
              bll_ysj.Delete(model_jsxx.JSXXID);
            }
          }
          FormulaEditFormCol form01 = new FormulaEditFormCol(model_jsxx);
          form01.ShowDialog();
          break;
          #endregion
        case 1102://顺序填充
          ...
          if (SaveJSXX(startRow + 1, endRow + 1, startCol, endCol + 1))
          {
            ...
            {
              DeleteFormula(startRow + 1, endRow, startCol, endCol, 0);
              MessageBox.Show("失败");
            }
          }
          break;
        ...
        case 1103://删除公式
          ...
          axCellFormulaConfig.GetSelectRange(ref startCol, ref startRow, ref endCol, ref endRow);
          currentCol = axCellFormulaConfig.GetCurrentCol();
          if (DeleteFormula(startRow, endRow, startCol, endCol, currentCol))
          {
        ...
        case 1104://横向
          ...
          if (SaveJSXX(startRow, endRow + 1, startCol + 1, endCol + 1))
          {
            ...
            {
              DeleteFormula(startRow, endRow, startCol + 1, endCol, 0);
              MessageBox.Show("失败");
            }
          }
          break;
    ...
    private bool DeleteFormula(int startRow, int endRow, int startCol, int endCol, int currentCol)
    {
      bool flag = false;
      ...
      axCellFormulaConfig.SetCellString(currentCol, startRow, 0, "");
      Model.ENCO_JSXX_COL model_jsxx = new Model.ENCO_JSXX_COL();
      model_jsxx.JSXXID = jsxxidArray[0, currentCol];
      Model.ENCO_JSXXYSJ_COL model_jsxxysj = new Model.ENCO_JSXXYSJ_COL();
      model_jsxxysj.JSXXID = jsxxidArray[0, currentCol];
      flag = bll_jsxx.Delete(model_jsxx.JSXXID);
      bll_jsxxysj.Delete(model_jsxxysj.JSXXID);
      return flag;
    }
