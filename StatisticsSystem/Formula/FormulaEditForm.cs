...
namespace StatisticsSystem.Formula
{
  public partial class FormulaEditForm : Form
  {
    ...
    BLL.ENCO_JSXX bll_jsxx = new BLL.ENCO_JSXX();
    BLL.ENCO_JSXXYSJ bll_jsxxysj = new BLL.ENCO_JSXXYSJ();
    //BLL.ENCO_SJJDJJBL bll_jsjd = new BLL.ENCO_SJJDJJBL();
    Model.ENCO_JSXX model_jsxx = new Model.ENCO_JSXX();
    Model.ENCO_JSXXYSJ model_jsxxysj = new Model.ENCO_JSXXYSJ();
    ...
    public FormulaEditForm(Model.ENCO_JSXX _model_jsxx)
    {
      InitializeComponent();
