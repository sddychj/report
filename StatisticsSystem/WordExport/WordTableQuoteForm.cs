...
{
  public partial class WordTableQuoteForm : Form
  {
    StatisticsSystem.BLL.CODE_BBBMB bll_bbbm = new BLL.CODE_BBBMB();
    StatisticsSystem.BLL.ZN_YYBB_List bll_yybb_list = new BLL.ZN_YYBB_List();
    StatisticsSystem.BLL.ZN_YYBB bll_yybb = new BLL.ZN_YYBB();
    string tableNum = "";

    #region 初始化
    public WordTableQuoteForm()
    {
      InitializeComponent();
    }

    public WordTableQuoteForm(string _tableNum)
    {
      InitializeComponent();
    ...
    {
      Model.ZN_YYBB_List model = new Model.ZN_YYBB_List(listViewTarget.Items.Count);
