...
{
  public partial class DWZBBMChoiceForm : Form, MainForm.ICipherInputForm
  {
    ...
    public DWZBBMChoiceForm()
    {
      InitializeComponent();
    }

    public DWZBBMChoiceForm(string _tableNum)
    {
      InitializeComponent();
      tableNum = _tableNum;
    ...
    protected void BindCh()
    {
      ...
      for (int i = 0; i < checkedListBox1.Items.Count; i++)
      {
        ...
        Model.XMLVERSION_DW_HIDEROW model_dw = bll_dw.GetModel(MainForm.Current.Version, tableNum, dv["dwbm"].ToString());
        if (model_dw != null)
        {
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      ...
      for (int i = 0; i < checkedListBox1.Items.Count; i++)
      {
        ...
        {
          model_dw = bll_dw.GetModel(MainForm.Current.Version, tableNum, dv["dwbm"].ToString());
          if (model_dw == null)
          {
            model_dw = GetModelDw();
        ...
        {
          bll_dw.Delete(MainForm.Current.Version, tableNum, dv["dwbm"].ToString());
        }
      }
