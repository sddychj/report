...
{
  public partial class CheckEditFormCol : Form
  {
    StatisticsSystem.BLL.JYXX_YYBB bll_yybb = new BLL.JYXX_YYBB();
    StatisticsSystem.BLL.ENCO_BBZD bll_zd = new BLL.ENCO_BBZD();
    BLL.JYXXYSJ_COL bll_jyxxysj = new BLL.JYXXYSJ_COL();
    Model.JYXX_COL model_jyxx = new Model.JYXX_COL();
    Model.JYXXYSJ_COL model_jsxxysj = new Model.JYXXYSJ_COL();
    ...
    #region
    public CheckEditFormCol()
    {
      InitializeComponent();
    }

    public CheckEditFormCol(Model.JYXX_COL _model_jsxx)
    {
      InitializeComponent();
    ...
    private void InitInfo()
    {
      ...
      if (model_jyxx.ZD == columnNameList[currentCol - 1])
      {
        cbSFGXZD.Checked = true;
      }
      else { cbSFGXZD.Checked = false; }
    }
    ...
    {
      BLL.JYXX_COL bll = new BLL.JYXX_COL();
      model_jyxx.JYGX = cobO.SelectedItem.ToString();
      int currentCol = axCellQuoteTable.GetCurrentCol();
      if (cbSFGXZD.Checked)
      {
        model_jyxx.ZD = columnNameList[currentCol - 1];
      }
      else { model_jyxx.ZD = ""; }
    ...
    private string GetJYMC()
    {
      ...
      for (int i = 0; i < listBoxNum.Items.Count; i++)
      {
        ...
        Model.JYXXYSJ_COL model_ysj = bll_jyxxysj.GetModel(JYXXID, ONAME);
        if (model_ysj != null)
        {
