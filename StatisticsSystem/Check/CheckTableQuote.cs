...
{
  public partial class CheckTableQuote : Form
  {
    StatisticsSystem.BLL.CODE_BBBMB bll_bbbm = new BLL.CODE_BBBMB();
    StatisticsSystem.BLL.JYXX_YYBB_List bll_yybb_list = new BLL.JYXX_YYBB_List();
    StatisticsSystem.BLL.JYXX_YYBB bll_yybb = new BLL.JYXX_YYBB();
    string tableNum = "";

    #region 初始化
    public CheckTableQuote()
    {
      InitializeComponent();
    }

    public CheckTableQuote(string _tableNum)
    {
      InitializeComponent();
