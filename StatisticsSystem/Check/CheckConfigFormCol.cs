...
{
  public partial class CheckConfigFormCol : Form
  {
    BLL.JYXX_COL bll_jyxx = new BLL.JYXX_COL();
    BLL.JYXXYSJ_COL bll_ysj = new BLL.JYXXYSJ_COL();
    #region
    public CheckConfigFormCol()
    {
      InitializeComponent();
      this.Text = "报表校验配置";
      BindBBLX();
    ...
    {
      Model.JYXX_COL model = bll_jyxx.GetModel(jyxxid);
      model.JYXXID = jyxxid;
      model.JYMS = formula.ToUpper();
      model.JYMC = jymc;
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      for (int i = 0; i < openTableGrid.Rows.Count; i++)
      {
        ...
        Model.JYXX_COL model = bll_jyxx.GetModel(int.Parse(jyid));
