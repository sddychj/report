...
namespace StatisticsSystem.BLL
{
  ...
  {
    private readonly StatisticsSystem.DAL.JYXXYSJ dal = new StatisticsSystem.DAL.JYXXYSJ();
    public JYXXYSJ()
    { }
    #region  BasicMethod
    /// <summary>
    ...
    /// 得到一个对象实体，从缓存中
    /// </summary>
    //public StatisticsSystem.Model.JYXXYSJ GetModelByCache(decimal JYXXID, string ONAME)
    //{

    //  string CacheKey = "JYXXYSJModel-" + JYXXID + ONAME;
    ...
    //    catch { }
    //  }
    //  return (StatisticsSystem.Model.JYXXYSJ)objModel;
    //}
    ...
    /// 获得数据列表
    /// </summary>
    public List<StatisticsSystem.Model.JYXXYSJ> GetModelList(string strWhere)
    {
    ...
    /// 获得数据列表
    /// </summary>
    public List<StatisticsSystem.Model.JYXXYSJ> DataTableToList(DataTable dt)
    {
      List<StatisticsSystem.Model.JYXXYSJ> modelList = new List<StatisticsSystem.Model.JYXXYSJ>();
      int rowsCount = dt.Rows.Count;
      if (rowsCount > 0)
      {
        StatisticsSystem.Model.JYXXYSJ model;
