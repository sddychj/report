...
namespace DBUtilityOdp
{
  ...
  public abstract class DbHelperOra
  {
    ...
    //public static string connectionString = Properties.Settings1.Default.conn_oracle;

    public static string connectionString
    {
      get
      {
        string username = DEncrypt.Decrypt(System.Configuration.ConfigurationManager.AppSettings["username"].ToString(), "qq");
        string pwd = DEncrypt.Decrypt(System.Configuration.ConfigurationManager.AppSettings["pwd"].ToString(), "qq");
        string ip = DEncrypt.Decrypt(System.Configuration.ConfigurationManager.AppSettings["ip"].ToString(), "qq");
        string port = DEncrypt.Decrypt(System.Configuration.ConfigurationManager.AppSettings["port"].ToString(), "qq");
        string db = DEncrypt.Decrypt(System.Configuration.ConfigurationManager.AppSettings["db"].ToString(), "qq");
        string _connectionString = @"Data Source=(DESCRIPTION=
    ...
    public static int ExecuteSql(string SQLString, string content)
    {
      using (OracleConnection connection = new OracleConnection(connectionString))
      {
        ...
        Oracle.DataAccess.Client.OracleParameter myParameter = new Oracle.DataAccess.Client.OracleParameter("@content", OracleDbType.Varchar2);
    ...
    public static int ExecuteSqlInsertImg(string strSQL, byte[] fs)
    {
      using (OracleConnection connection = new OracleConnection(connectionString))
      {
        ...
        Oracle.DataAccess.Client.OracleParameter myParameter = new Oracle.DataAccess.Client.OracleParameter("@fs", OracleDbType.LongRaw);
    ...
    public static int BatchInsert(string tableName, Dictionary<string, object> columnRowData, int len)
    {
      ...
      int iResult = 0;
      string[] dbColumns = new string[columnRowData.Count];
    ...
    public static int ExecuteSql(string SQLString, int recc, params OracleParameter[] cmdParms)
    {
      using (OracleConnection connection = new OracleConnection(connectionString))
      {
        using (OracleCommand cmd = new OracleCommand())
